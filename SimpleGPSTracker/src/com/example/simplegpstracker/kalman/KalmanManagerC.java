...
public class KalmanManagerC implements KManager{
    ...
    public void setParam(Location location, GPSInfo info){    	
        ...
        if (mLatitudeTracker == null) {
        	...
        	mLatitudeTracker = new Kalman2D(position, location.getSpeed(), timeStepShared, COORDINATE_NOISE);
        ...
        if (mLongitudeTracker == null) {
            ...
            mLongitudeTracker = new Kalman2D(position, location.getSpeed(), timeStepShared, COORDINATE_NOISE);
